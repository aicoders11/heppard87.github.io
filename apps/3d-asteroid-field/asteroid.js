(function() {
    ...
    function createExplosion(pos) {
        for(let i=0; i<10; i++) {
            ...
            particles.push(p);
            scene.add(p);
            setTimeout(() => { scene.remove(p); particles.splice(particles.indexOf(p), 1); }, 1000);
        }
    }
